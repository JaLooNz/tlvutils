...
/**
 * The PrimitiveBERTag class encapsulates a primitive BER TLV tag. The rules on the allowed
...
public class PrimitiveBERTag extends BERTag {
    /**
     * Constructor creates an empty PrimitiveBERTag object capable of encapsulating a primitive BER
     * TLV Tag. All implementations must support at least 3 byte Tags which can encode tag numbers
     * up to 0x3FFF.
     */
