...
/**
 * The ConstructedBERTag class encapsulates a constructed BER TLV tag. The rules
 * on the allowed encoding of the Tag field is based on the ASN.1 BER encoding
 * rules of ISO/IEC 8825-1:2002.
 * <p/>
 * The BERTag class and the subclasses {@link ConstructedBERTag} and
...
public class ConstructedBERTag extends BERTag {
	/**
	 * Constructor creates an empty constructed {@link BERTLV} Tag object capable of
	 * encapsulating a constructed BER TLV Tag. All implementations must support at
